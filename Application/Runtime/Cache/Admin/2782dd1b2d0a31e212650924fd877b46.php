<?php if (!defined('THINK_PATH')) exit();?><form class="layui-form">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="project_name" lay-verify="required" value="<?php echo ($project_info['project_name']); ?>" placeholder="请输入项目名" autocomplete="off"  id="name" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">合同金额</label>
    <div class="layui-input-inline">
      <input type="text" name="money" lay-verify="required" value="<?php echo ($project_info['money']); ?>"placeholder="请输入合同金额" autocomplete="off" id="money" class="layui-input">
    </div>
  </div>
