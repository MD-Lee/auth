	...
	<body>
		<div class="layui-layout layui-layout-admin">
						...
						<li class="layui-nav-item">
							...
							<dl class="layui-nav-child">
								...
								<dd>
									...
									<a href="javascript:;" data-url="<?php echo U('Person/changePwd');?>"><i class="fa fa-gear" aria-hidden="true"></i> 修改密码</a>
								</dd>
								<dd>
			...
			<div class="layui-footer footer footer-demo">
				<div class="layui-main">
					<p>2017 &copy;
						<a href="http://beginner.zhengjinfan.cn/demo/beginner_admin/">绩效管理后台</a>
					</p>
				</div>
			</div>
			...
			<script>
                layui.use(['element', 'layer'], function() {
                    ...
                    var $container = $('#admin-tab-container');
                    //绑定 nav 点击事件
                    $('.layui-nav-child').find('dd > a').each(function() {
                        var $this = $(this);
                        //获取设定的url
                        var url = $this.data('url');
                        if(url !== undefined) {
