			...
			<fieldset class="layui-elem-field">
				...
				<table class="layui-table">
					  ...
					  <?php if(is_array($company_info)): foreach($company_info as $k=>$vo): ?><tr>
					      ...
					      <td style="width:10%"><?php echo ($vo['id']); ?></td>

					      <td style="width:45%" class="p_group"><span><?php echo ($vo["name"]); ?></span><p class="t_arrow">&nbsp;</p></td>
					      <td style="width:45%">
                        ...
                        <tr class="group_tgl">
                        	<td colspan="3" style="margin:0; padding:0;">
                                ...
                                <?php if(is_array($vo["group_list"])): foreach($vo["group_list"] as $key=>$t): ?><tr class="group_row">
                                       <td class="first_r" style="width:10%;"></td>
                                       <td class="group_row" style="width:45%"><?php echo ($t["group_name"]); ?></td>
                                       <td class="last_r group_row" style="width:45%">
                                            <a data="<?php echo ($t["id"]); ?>" class="layui-btn layui-btn-mini layui-btn-normal groupedit"><i class="layui-icon">&#xe642;</i>编辑</a>
